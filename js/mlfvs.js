(function($) {
	...
	$.fn.extend({
        collapsiblePanel2: function() {
            // Call the ConfigureCollapsiblePanel function for the selected element
            return $(this).each(ConfigureCollapsiblePanel2);
        }
    });
...
function ConfigureCollapsiblePanel() {
    ...
    $("<div class='collapsibleContainerTitle ui-widget-header'><div>" + $(this).attr("showTitle") + "<img src='img/tab.png' style='position: absolute; bottom: 0px;left: 0px;z-index:-1;'></div></div>").prependTo($(this));
...
function ConfigureCollapsiblePanel2() {
    ...
    // Wrap the contents of the container within a new div.
    $(this).children().wrapAll("<div class='collapsibleContainerContent2 ui-widget-content'></div>");

    // Create a new div as the first item within the container.  Put the title of the panel in here.
    $("<div class='collapsibleContainerTitle ui-widget-header'><div><img src='img/tab_top_wband.png'><h1>" + $(this).attr("showTitle") + "</h1></div></div>").prependTo($(this));

    // Assign a call to CollapsibleContainerTitleOnClick for the click event of the new title div.
    $(".collapsibleContainerTitle", this).click(CollapsibleContainerTitle2OnClick);
	
	$(".collapsibleContainerContent2", $(this).parent()).slideDown();
}

function CollapsibleContainerTitle2OnClick() {
    // The item clicked is the title div... get this parent (the overall container) and toggle the content within it.
    $(".collapsibleContainerContent2", $(this).parent()).slideToggle();
}
		...
		init : function(options)
		{
    	    return this.each(function() 
    	    {
				...
				imgLoad.onload=function(){
					...
					var cpoxMinus80 = cpox - 80;
					var cpoyMinus80 = cpoy -80;

					controlsDiv.css({'left':cpoxMinus80,'top':cpoyMinus80});
				};
